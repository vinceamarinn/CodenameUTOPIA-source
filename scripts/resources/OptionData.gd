...
@export_range(1, 5, 1) var TextScrollSpeed:int = 3 ## Controls how fast the text scrolls in dialogue and things of the sort.
@export var TextAutoScroll:bool = false ## Determines whether or not dialogue text automatically continues after a few seconds.
...
@export var TextLanguage:String = "en" ## Language of the game text.
